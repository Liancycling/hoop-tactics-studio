(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const u of s.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&n(u)}).observe(document,{childList:!0,subtree:!0});function i(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(a){if(a.ep)return;a.ep=!0;const s=i(a);fetch(a.href,s)}})();const K=[{id:"pnr-roll",name:"1. 基本順下 (Pick & Roll)",category:"高位擋拆經典",summary:"持球衛與內線球員在頂弧進行高位擋拆，掩護者拆開後迅速空切順下禁區接球籃下攻門。",keyConcepts:["掩護角度：掩護者需站在防守球員側後方 45 度角紮實設掩。","持球突破：控球衛繞過掩護後必須發動強攻拆解，吸引協防。","空切順下：中鋒/大前鋒擋完即切，視防守站位要求空中接力或順下上籃。"],players:{offense:[{id:"PG",label:"PG (1號)",color:"#38ef7d"},{id:"C",label:"C (5號)",color:"#38ef7d"},{id:"SG",label:"SG (2號)",color:"#38ef7d"},{id:"SF",label:"SF (3號)",color:"#38ef7d"},{id:"PF",label:"PF (4號)",color:"#38ef7d"}],defense:[{id:"D1",label:"D1",color:"#ff5252"},{id:"D5",label:"D5",color:"#ff5252"},{id:"D2",label:"D2",color:"#ff5252"},{id:"D3",label:"D3",color:"#ff5252"},{id:"D4",label:"D4",color:"#ff5252"}]},keyframes:[{progress:0,time:"0.0s",desc:"1. 戰術起勢：PG 在頂弧持球，C 準備上提進行高位掩護；其餘隊友拉開底角清空中路空間。",ballOwner:"PG",positions:{PG:{x:50,y:70},C:{x:50,y:45},SG:{x:15,y:75},SF:{x:85,y:75},PF:{x:88,y:30},D1:{x:50,y:65},D5:{x:50,y:40},D2:{x:20,y:70},D3:{x:80,y:70},D4:{x:80,y:35}}},{progress:30,time:"1.5s",desc:"2. 擋拆設掩：C 落地紮實掩護 D1，PG 貼身切過掩護往右側斜向突破。",ballOwner:"PG",positions:{PG:{x:40,y:55},C:{x:48,y:62},SG:{x:15,y:75},SF:{x:85,y:75},PF:{x:88,y:30},D1:{x:45,y:64},D5:{x:42,y:50},D2:{x:20,y:70},D3:{x:80,y:70},D4:{x:75,y:35}}},{progress:65,time:"3.2s",desc:"3. 順下與精準傳球：D5 被迫上提包夾 PG，C 抓住空隙快速轉身直奔禁區，PG 送出擊地傳球。",ballOwner:"C",positions:{PG:{x:30,y:45},C:{x:50,y:25},SG:{x:15,y:75},SF:{x:85,y:75},PF:{x:88,y:30},D1:{x:40,y:55},D5:{x:32,y:42},D2:{x:20,y:70},D3:{x:80,y:70},D4:{x:70,y:30}}},{progress:100,time:"5.0s",desc:"4. 禁區完成得分：C 在籃下輕鬆接球完成雙手暴扣或高板上籃！",ballOwner:"C",positions:{PG:{x:28,y:40},C:{x:50,y:12},SG:{x:15,y:75},SF:{x:85,y:75},PF:{x:88,y:30},D1:{x:38,y:48},D5:{x:35,y:35},D2:{x:20,y:70},D3:{x:80,y:70},D4:{x:65,y:22}}}]},{id:"pnr-pop",name:"2. 擋拆彈出 (Pick & Pop)",category:"空間拉開戰術",summary:"內線球員擋拆後不往禁區切，而是外彈至三分線外接球投射，懲罰防守沉退。",keyConcepts:["外彈拉開空間：掩護者具備外線投射能力，擋拆後迅速往後退至弧頂/45度角。","閱讀沉退防守：當防守中鋒選擇深入禁區蹲守時， Pick & Pop 擁有極佳三分出手機會。"],players:{offense:[{id:"PG",label:"PG (1號)",color:"#38ef7d"},{id:"PF",label:"PF (4號)",color:"#38ef7d"},{id:"SG",label:"SG (2號)",color:"#38ef7d"},{id:"SF",label:"SF (3號)",color:"#38ef7d"},{id:"C",label:"C (5號)",color:"#38ef7d"}],defense:[{id:"D1",label:"D1",color:"#ff5252"},{id:"D4",label:"D4",color:"#ff5252"},{id:"D2",label:"D2",color:"#ff5252"},{id:"D3",label:"D3",color:"#ff5252"},{id:"D5",label:"D5",color:"#ff5252"}]},keyframes:[{progress:0,time:"0.0s",desc:"1. 戰術初始：PG 於左側 45 度角發動，具有投射能力的大前鋒 PF 上提擋拆。",ballOwner:"PG",positions:{PG:{x:35,y:65},PF:{x:42,y:55},SG:{x:15,y:75},SF:{x:85,y:75},C:{x:85,y:25},D1:{x:35,y:60},D4:{x:42,y:50},D2:{x:18,y:70},D3:{x:82,y:70},D5:{x:75,y:30}}},{progress:40,time:"2.0s",desc:"2. 防守收縮：D4 擔心 PG 切入而向禁區收縮沉退，PF 擋完後迅速向弧頂外彈。",ballOwner:"PG",positions:{PG:{x:25,y:40},PF:{x:50,y:72},SG:{x:15,y:75},SF:{x:85,y:75},C:{x:85,y:25},D1:{x:28,y:48},D4:{x:35,y:30},D2:{x:18,y:70},D3:{x:82,y:70},D5:{x:75,y:30}}},{progress:75,time:"3.8s",desc:"3. 橫傳弧頂：PG 切入吸住兩名防守後回傳弧頂空檔的 PF。",ballOwner:"PF",positions:{PG:{x:20,y:35},PF:{x:50,y:72},SG:{x:15,y:75},SF:{x:85,y:75},C:{x:85,y:25},D1:{x:24,y:40},D4:{x:30,y:28},D2:{x:18,y:70},D3:{x:82,y:70},D5:{x:75,y:30}}},{progress:100,time:"5.2s",desc:"4. 三分命中：PF 在無人看管下出手命中高弧度三分球！",ballOwner:"PF",positions:{PG:{x:20,y:35},PF:{x:50,y:72},SG:{x:15,y:75},SF:{x:85,y:75},C:{x:85,y:25},D1:{x:24,y:40},D4:{x:40,y:55},D2:{x:18,y:70},D3:{x:82,y:70},D5:{x:75,y:30}}}]},{id:"pnr-spanish",name:"3. 西班牙擋拆 (Spanish P&R)",category:"高階雙重擋拆",summary:"在高位擋拆的同時，安排第三名射手在禁區為沉退的協防中鋒做背後二次掩護，徹底撕裂防線。",keyConcepts:["背後掩護 (Back Screen)：射手為防守中鋒做背掩，阻擋其封蓋順下的 C。","雙重威脅：防守方若換防背掩，射手便可在弧頂空檔接球遠投。"],players:{offense:[{id:"PG",label:"PG (1號)",color:"#38ef7d"},{id:"C",label:"C (5號)",color:"#38ef7d"},{id:"SG",label:"SG (2號)",color:"#38ef7d"},{id:"SF",label:"SF (3號)",color:"#38ef7d"},{id:"PF",label:"PF (4號)",color:"#38ef7d"}],defense:[{id:"D1",label:"D1",color:"#ff5252"},{id:"D5",label:"D5",color:"#ff5252"},{id:"D2",label:"D2",color:"#ff5252"},{id:"D3",label:"D3",color:"#ff5252"},{id:"D4",label:"D4",color:"#ff5252"}]},keyframes:[{progress:0,time:"0.0s",desc:"1. 戰術佈局：PG 頂弧發動，C 上提掩護。SG 藏在罰球線附近準備做背後掩護。",ballOwner:"PG",positions:{PG:{x:50,y:75},C:{x:50,y:55},SG:{x:50,y:35},SF:{x:15,y:75},PF:{x:85,y:75},D1:{x:50,y:70},D5:{x:50,y:48},D2:{x:50,y:30},D3:{x:18,y:70},D4:{x:82,y:70}}},{progress:50,time:"2.5s",desc:"2. 雙重擋拆啟動：PG 繞 C 突破，C 順下的同時，SG 給沉退防守的 D5 一個致命的背後掩護！",ballOwner:"PG",positions:{PG:{x:35,y:50},C:{x:50,y:28},SG:{x:50,y:38},SF:{x:15,y:75},PF:{x:85,y:75},D1:{x:42,y:58},D5:{x:50,y:36},D2:{x:52,y:45},D3:{x:18,y:70},D4:{x:82,y:70}}},{progress:100,time:"4.8s",desc:"3. 空接灌籃：D5 被徹底卡死無法起跳，PG 高拋空中接力傳給 C 完成空中灌籃！",ballOwner:"C",positions:{PG:{x:30,y:42},C:{x:50,y:12},SG:{x:55,y:65},SF:{x:15,y:75},PF:{x:85,y:75},D1:{x:36,y:48},D5:{x:50,y:32},D2:{x:52,y:45},D3:{x:18,y:70},D4:{x:82,y:70}}}]},{id:"pnr-ghost",name:"4. 幽靈掩護 (Ghost Screen)",category:"現代小球戰術",summary:"掩護者看似要上提做實質身體接觸擋拆，卻在接觸前一瞬間假擋並快速彈出，創造防守溝通混亂。",keyConcepts:["假擋真彈 (Fake Screen & Slip)：完全不與防守者接觸，突然改變路線彈向弧頂或邊角。","製造防守防守溝通失誤：防守方準備準備換防時，兩人常會同時撲向持球者或漏掉假擋者。"],players:{offense:[{id:"PG",label:"PG (1號)",color:"#38ef7d"},{id:"SG",label:"SG (2號)",color:"#38ef7d"},{id:"SF",label:"SF (3號)",color:"#38ef7d"},{id:"PF",label:"PF (4號)",color:"#38ef7d"},{id:"C",label:"C (5號)",color:"#38ef7d"}],defense:[{id:"D1",label:"D1",color:"#ff5252"},{id:"D2",label:"D2",color:"#ff5252"},{id:"D3",label:"D3",color:"#ff5252"},{id:"D4",label:"D4",color:"#ff5252"},{id:"D5",label:"D5",color:"#ff5252"}]},keyframes:[{progress:0,time:"0.0s",desc:"1. 姿態偽裝：SG 擺出要上提為 PG 做高位擋拆的姿勢，防守者 D2 準備進行換防溝通。",ballOwner:"PG",positions:{PG:{x:40,y:70},SG:{x:45,y:55},SF:{x:15,y:75},PF:{x:85,y:75},C:{x:85,y:25},D1:{x:40,y:64},D2:{x:45,y:50},D3:{x:18,y:70},D4:{x:82,y:70},D5:{x:75,y:30}}},{progress:50,time:"2.0s",desc:"2. 幽靈假擋：SG 未接觸 D1 便突然加速向右側 45 度角彈出！D1 與 D2 瞬間產生猶豫包夾 PG。",ballOwner:"PG",positions:{PG:{x:30,y:55},SG:{x:70,y:65},SF:{x:15,y:75},PF:{x:85,y:75},C:{x:85,y:25},D1:{x:35,y:55},D2:{x:38,y:56},D3:{x:18,y:70},D4:{x:82,y:70},D5:{x:75,y:30}}},{progress:100,time:"4.2s",desc:"3. 分球空檔出手：PG 精準分球給右側完全空檔的 SG，輕鬆出手射入三分球！",ballOwner:"SG",positions:{PG:{x:28,y:52},SG:{x:70,y:65},SF:{x:15,y:75},PF:{x:85,y:75},C:{x:85,y:25},D1:{x:32,y:54},D2:{x:48,y:60},D3:{x:18,y:70},D4:{x:82,y:70},D5:{x:75,y:30}}}]},{id:"pnr-drag",name:"5. 轉換拖曳擋拆 (Drag Screen)",category:"快攻轉換戰術",summary:"在快攻轉換推進中，防守方陣型尚未立穩時，大個子球員跟進在半場進行快速拖曳擋拆。",keyConcepts:["趁虛而入：利用對方退防未定的混亂期發動擋拆。","節奏變化：持球者利用拖曳擋拆加速切入，常能直接撕裂對手半場防線。"],players:{offense:[{id:"PG",label:"PG (1號)",color:"#38ef7d"},{id:"PF",label:"PF (4號)",color:"#38ef7d"},{id:"SG",label:"SG (2號)",color:"#38ef7d"},{id:"SF",label:"SF (3號)",color:"#38ef7d"},{id:"C",label:"C (5號)",color:"#38ef7d"}],defense:[{id:"D1",label:"D1",color:"#ff5252"},{id:"D4",label:"D4",color:"#ff5252"},{id:"D2",label:"D2",color:"#ff5252"},{id:"D3",label:"D3",color:"#ff5252"},{id:"D5",label:"D5",color:"#ff5252"}]},keyframes:[{progress:0,time:"0.0s",desc:"1. 快攻推進：PG 迅速運球過半場，拖後跟進的 PF 在中圈附近直接發動 Drag Screen。",ballOwner:"PG",positions:{PG:{x:50,y:80},PF:{x:50,y:88},SG:{x:15,y:65},SF:{x:85,y:65},C:{x:75,y:30},D1:{x:50,y:72},D4:{x:55,y:82},D2:{x:20,y:60},D3:{x:80,y:60},D5:{x:70,y:25}}},{progress:60,time:"2.2s",desc:"2. 行進間掩護：PF 在高速運球中給 D1 掩護，PG 一步加速直插油漆區！",ballOwner:"PG",positions:{PG:{x:45,y:40},PF:{x:52,y:68},SG:{x:15,y:65},SF:{x:85,y:65},C:{x:75,y:30},D1:{x:50,y:68},D4:{x:48,y:48},D2:{x:20,y:60},D3:{x:80,y:60},D5:{x:65,y:25}}},{progress:100,time:"3.8s",desc:"3. 騎馬射箭得分：對手內線尚未站定防守位置，PG 拋投上籃輕鬆取分！",ballOwner:"PG",positions:{PG:{x:50,y:18},PF:{x:52,y:60},SG:{x:15,y:65},SF:{x:85,y:65},C:{x:75,y:30},D1:{x:48,y:55},D4:{x:45,y:25},D2:{x:20,y:60},D3:{x:80,y:60},D5:{x:60,y:20}}}]}];class xe{constructor(r,i={}){this.container=r,this.options=i,this.currentTactic=null,this.progress=0,this.onPositionUpdate=i.onPositionUpdate||null,this.draggedPlayerId=null,this.bindPointerAndTouchEvents()}setTactic(r){this.currentTactic=r,this.progress=0,this.render()}setProgress(r){this.progress=Math.max(0,Math.min(100,r)),this.render()}getCurrentFrameState(){if(!this.currentTactic||!this.currentTactic.keyframes.length)return null;const r=this.currentTactic.keyframes;if(this.progress<=0)return r[0];if(this.progress>=100)return r[r.length-1];let i=0;for(let m=0;m<r.length-1;m++)if(this.progress>=r[m].progress&&this.progress<=r[m+1].progress){i=m;break}const n=r[i],a=r[i+1],s=a.progress-n.progress,u=(this.progress-n.progress)/s,g={};return Object.keys(n.positions).forEach(m=>{const S=n.positions[m],C=a.positions[m];S&&C&&(g[m]={x:S.x+(C.x-S.x)*u,y:S.y+(C.y-S.y)*u})}),{progress:this.progress,desc:u>.5?a.desc:n.desc,ballOwner:u>.5?a.ballOwner:n.ballOwner,positions:g,currentStepIndex:i}}eventToCourtCoords(r){const i=this.container.querySelector("svg");if(!i)return null;const n=i.getBoundingClientRect();let a,s;if(r.touches&&r.touches.length>0?(a=r.touches[0].clientX,s=r.touches[0].clientY):r.changedTouches&&r.changedTouches.length>0?(a=r.changedTouches[0].clientX,s=r.changedTouches[0].clientY):(a=r.clientX,s=r.clientY),a===void 0||s===void 0)return null;const u=a-n.left,g=s-n.top,D=u/n.width*1e3,m=g/n.height*800;let S=(D-50)/900*100,C=(m-40)/720*100;return S=Math.max(2,Math.min(98,S)),C=Math.max(2,Math.min(98,C)),{x:S,y:C}}bindPointerAndTouchEvents(){const r=a=>{const s=a.target.closest(".player-group");if(s){if(a.cancelable&&a.preventDefault(),this.draggedPlayerId=s.getAttribute("data-player-id"),a.pointerId!==void 0&&s.setPointerCapture)try{s.setPointerCapture(a.pointerId)}catch{}this.render()}},i=a=>{if(!this.draggedPlayerId||!this.currentTactic)return;a.cancelable&&a.preventDefault();const s=this.eventToCourtCoords(a);if(!s)return;const u=this.getCurrentFrameState();if(!u)return;const g=this.currentTactic.keyframes[u.currentStepIndex];g&&g.positions[this.draggedPlayerId]&&(g.positions[this.draggedPlayerId].x=s.x,g.positions[this.draggedPlayerId].y=s.y,this.onPositionUpdate&&this.onPositionUpdate(this.draggedPlayerId,s,u.currentStepIndex),this.render())},n=a=>{this.draggedPlayerId&&(this.draggedPlayerId=null,this.render())};this.container.addEventListener("pointerdown",r),window.addEventListener("pointermove",i),window.addEventListener("pointerup",n),window.addEventListener("pointercancel",n),this.container.addEventListener("touchstart",r,{passive:!1}),window.addEventListener("touchmove",i,{passive:!1}),window.addEventListener("touchend",n),window.addEventListener("touchcancel",n),this.container.addEventListener("mousedown",r),window.addEventListener("mousemove",i),window.addEventListener("mouseup",n)}render(){if(!this.currentTactic)return;const r=this.getCurrentFrameState();if(!r)return;let i=`
    ...
    `;i+=this.renderTacticalPaths(r),this.currentTactic.players.defense.forEach(n=>{const a=r.positions[n.id];if(a){const s=a.x/100*900+50,u=a.y/100*720+40,g=this.draggedPlayerId===n.id;i+=`
          <g class="player-group" data-player-id="${n.id}" transform="translate(${s}, ${u})" style="cursor: move; touch-action: none; -webkit-tap-highlight-color: transparent;">
            <!-- 隱形透明觸控熱區 (Hitbox r=42) -->
            <circle r="42" fill="transparent" />
            <!-- 實體球員圖層 -->
            <circle r="${g?30:24}" fill="#2d151e" stroke="#ff5252" stroke-width="${g?6:3.5}" filter="url(#glow-defense)" />
            <text x="0" y="6" text-anchor="middle" fill="#ff5252" font-size="15" font-weight="900" font-family="Inter, sans-serif" pointer-events="none">${n.label}</text>
          </g>
        `}}),this.currentTactic.players.offense.forEach(n=>{const a=r.positions[n.id];if(a){const s=a.x/100*900+50,u=a.y/100*720+40,g=r.ballOwner===n.id,D=this.draggedPlayerId===n.id;i+=`
          <g class="player-group" data-player-id="${n.id}" transform="translate(${s}, ${u})" style="cursor: move; touch-action: none; -webkit-tap-highlight-color: transparent;">
            <!-- 隱形透明觸控熱區 (Hitbox r=45) -->
            <circle r="45" fill="transparent" />
            <!-- 實體球員圖層 -->
            <circle r="${D?32:26}" fill="#132e23" stroke="#38ef7d" stroke-width="${D?6:4}" filter="url(#glow-offense)" />
            <text x="0" y="6" text-anchor="middle" fill="#38ef7d" font-size="15" font-weight="900" font-family="Inter, sans-serif" pointer-events="none">${n.id}</text>
        ...
        `}}),i+="</svg>",this.container.innerHTML=i}renderTacticalPaths(r){let i="";const n=this.currentTactic.keyframes;for(let a=0;a<n.length-1;a++){const s=n[a],u=n[a+1];if(Object.keys(s.positions).forEach(g=>{const D=s.positions[g],m=u.positions[g];if(D&&m&&(Math.abs(D.x-m.x)>1.5||Math.abs(D.y-m.y)>1.5)){const S=D.x/100*900+50,C=D.y/100*720+40,G=m.x/100*900+50,B=m.y/100*720+40,L=g.startsWith("P")||g==="C"||g.startsWith("S");i+=`
            <line x1="${S}" y1="${C}" x2="${G}" y2="${B}" 
                  stroke="${L?"rgba(56, 239, 125, 0.5)":"rgba(255, 82, 82, 0.35)"}" 
                  stroke-width="3" stroke-dasharray="6 6" 
                  marker-end="${L?"url(#arrow-offense)":""}" />
          `}}),s.ballOwner&&u.ballOwner&&s.ballOwner!==u.ballOwner){const g=s.positions[s.ballOwner],D=u.positions[u.ballOwner];if(g&&D){const m=g.x/100*900+50,S=g.y/100*720+40,C=D.x/100*900+50,G=D.y/100*720+40;i+=`
            <line x1="${m}" y1="${S}" x2="${C}" y2="${G}" 
                  stroke="#ffb703" stroke-width="4" stroke-dasharray="8 6" 
                  marker-end="url(#arrow-pass)" />
          `}}}return i}}var z={};(function $(r,i,n,a){var s=!!(r.Worker&&r.Blob&&r.Promise&&r.OffscreenCanvas&&r.OffscreenCanvasRenderingContext2D&&r.HTMLCanvasElement&&r.HTMLCanvasElement.prototype.transferControlToOffscreen&&r.URL&&r.URL.createObjectURL),u=typeof Path2D=="function"&&typeof DOMMatrix=="function",g=function(){if(!r.OffscreenCanvas)return!1;try{var t=new OffscreenCanvas(1,1),e=t.getContext("2d");e.fillRect(0,0,1,1);var o=t.transferToImageBitmap();e.createPattern(o,"no-repeat")}catch{return!1}return!0}();function D(){}function m(t){var e=i.exports.Promise,o=e!==void 0?e:r.Promise;return typeof o=="function"?new o(t):(t(D,D),null)}var S=function(t,e){return{transform:function(o){if(t)return o;if(e.has(o))return e.get(o);var c=new OffscreenCanvas(o.width,o.height),d=c.getContext("2d");return d.drawImage(o,0,0),e.set(o,c),c},clear:function(){e.clear()}}}(g,new Map),C=function(){var t=Math.floor(16.666666666666668),e,o,c={},d=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(e=function(h){var y=Math.random();return c[y]=requestAnimationFrame(function l(f){d===f||d+t-1<f?(d=f,delete c[y],h()):c[y]=requestAnimationFrame(l)}),y},o=function(h){c[h]&&cancelAnimationFrame(c[h])}):(e=function(h){return setTimeout(h,t)},o=function(h){return clearTimeout(h)}),{frame:e,cancel:o}}(),G=function(){var t,e,o={};function c(d){function h(y,l){d.postMessage({options:y||{},callback:l})}d.init=function(l){var f=l.transferControlToOffscreen();d.postMessage({canvas:f},[f])},d.fire=function(l,f,v){if(e)return h(l,null),e;var w=Math.random().toString(36).slice(2);return e=m(function(x){function P(M){M.data.callback===w&&(delete o[w],d.removeEventListener("message",P),e=null,S.clear(),v(),x())}d.addEventListener("message",P),h(l,w),o[w]=P.bind(null,{data:{callback:w}})}),e},d.reset=function(){d.postMessage({reset:!0});for(var l in o)o[l](),delete o[l]}}return function(){if(t)return t;if(!n&&s){var d=["var CONFETTI, SIZE = {}, module = {};","("+$.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{t=new Worker(URL.createObjectURL(new Blob([d])))}catch(h){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",h),null}c(t)}return t}}(),B={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function L(t,e){return e?e(t):t}function R(t){return t!=null}function b(t,e,o){return L(t&&R(t[e])?t[e]:B[e],o)}function N(t){return t<0?0:Math.floor(t)}function H(t,e){return Math.floor(Math.random()*(e-t))+t}function A(t){return parseInt(t,16)}function Z(t){return t.map(Q)}function Q(t){var e=String(t).replace(/[^0-9a-f]/gi,"");return e.length<6&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),{r:A(e.substring(0,2)),g:A(e.substring(2,4)),b:A(e.substring(4,6))}}function ee(t){var e=b(t,"origin",Object);return e.x=b(e,"x",Number),e.y=b(e,"y",Number),e}function te(t){t.width=document.documentElement.clientWidth,t.height=document.documentElement.clientHeight}function re(t){var e=t.getBoundingClientRect();t.width=e.width,t.height=e.height}function ae(t){var e=document.createElement("canvas");return e.style.position="fixed",e.style.top="0px",e.style.left="0px",e.style.pointerEvents="none",e.style.zIndex=t,e}function se(t,e,o,c,d,h,y,l,f){t.save(),t.translate(e,o),t.rotate(h),t.scale(c,d),t.arc(0,0,1,y,l,f),t.restore()}function ie(t){var e=t.angle*(Math.PI/180),o=t.spread*(Math.PI/180);return{x:t.x,y:t.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:t.startVelocity*.5+Math.random()*t.startVelocity,angle2D:-e+(.5*o-Math.random()*o),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:t.color,shape:t.shape,tick:0,totalTicks:t.ticks,decay:t.decay,drift:t.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:t.gravity*3,ovalScalar:.6,scalar:t.scalar,flat:t.flat}}function ne(t,e){e.x+=Math.cos(e.angle2D)*e.velocity+e.drift,e.y+=Math.sin(e.angle2D)*e.velocity+e.gravity,e.velocity*=e.decay,e.flat?(e.wobble=0,e.wobbleX=e.x+10*e.scalar,e.wobbleY=e.y+10*e.scalar,e.tiltSin=0,e.tiltCos=0,e.random=1):(e.wobble+=e.wobbleSpeed,e.wobbleX=e.x+10*e.scalar*Math.cos(e.wobble),e.wobbleY=e.y+10*e.scalar*Math.sin(e.wobble),e.tiltAngle+=.1,e.tiltSin=Math.sin(e.tiltAngle),e.tiltCos=Math.cos(e.tiltAngle),e.random=Math.random()+2);var o=e.tick++/e.totalTicks,c=e.x+e.random*e.tiltCos,d=e.y+e.random*e.tiltSin,h=e.wobbleX+e.random*e.tiltCos,y=e.wobbleY+e.random*e.tiltSin;if(t.fillStyle="rgba("+e.color.r+", "+e.color.g+", "+e.color.b+", "+(1-o)+")",t.beginPath(),u&&e.shape.type==="path"&&typeof e.shape.path=="string"&&Array.isArray(e.shape.matrix))t.fill(le(e.shape.path,e.shape.matrix,e.x,e.y,Math.abs(h-c)*.1,Math.abs(y-d)*.1,Math.PI/10*e.wobble));else if(e.shape.type==="bitmap"){var l=Math.PI/10*e.wobble,f=Math.abs(h-c)*.1,v=Math.abs(y-d)*.1,w=e.shape.bitmap.width*e.scalar,x=e.shape.bitmap.height*e.scalar,P=new DOMMatrix([Math.cos(l)*f,Math.sin(l)*f,-Math.sin(l)*v,Math.cos(l)*v,e.x,e.y]);P.multiplySelf(new DOMMatrix(e.shape.matrix));var M=t.createPattern(S.transform(e.shape.bitmap),"no-repeat");M.setTransform(P),t.globalAlpha=1-o,t.fillStyle=M,t.fillRect(e.x-w/2,e.y-x/2,w,x),t.globalAlpha=1}else if(e.shape==="circle")t.ellipse?t.ellipse(e.x,e.y,Math.abs(h-c)*e.ovalScalar,Math.abs(y-d)*e.ovalScalar,Math.PI/10*e.wobble,0,2*Math.PI):se(t,e.x,e.y,Math.abs(h-c)*e.ovalScalar,Math.abs(y-d)*e.ovalScalar,Math.PI/10*e.wobble,0,2*Math.PI);else if(e.shape==="star")for(var p=Math.PI/2*3,k=4*e.scalar,T=8*e.scalar,F=e.x,E=e.y,O=5,I=Math.PI/O;O--;)F=e.x+Math.cos(p)*T,E=e.y+Math.sin(p)*T,t.lineTo(F,E),p+=I,F=e.x+Math.cos(p)*k,E=e.y+Math.sin(p)*k,t.lineTo(F,E),p+=I;else t.moveTo(Math.floor(e.x),Math.floor(e.y)),t.lineTo(Math.floor(e.wobbleX),Math.floor(d)),t.lineTo(Math.floor(h),Math.floor(y)),t.lineTo(Math.floor(c),Math.floor(e.wobbleY));return t.closePath(),t.fill(),e.tick<e.totalTicks}function oe(t,e,o,c,d){var h=e.slice(),y=t.getContext("2d"),l,f,v=m(function(w){function x(){l=f=null,y.clearRect(0,0,c.width,c.height),S.clear(),d(),w()}function P(){n&&!(c.width===a.width&&c.height===a.height)&&(c.width=t.width=a.width,c.height=t.height=a.height),!c.width&&!c.height&&(o(t),c.width=t.width,c.height=t.height),y.clearRect(0,0,c.width,c.height),h=h.filter(function(M){return ne(y,M)}),h.length?l=C.frame(P):x()}l=C.frame(P),f=x});return{addFettis:function(w){return h=h.concat(w),v},canvas:t,promise:v,reset:function(){l&&C.cancel(l),f&&f()}}}function j(t,e){var o=!t,c=!!b(e||{},"resize"),d=!1,h=b(e,"disableForReducedMotion",Boolean),y=s&&!!b(e||{},"useWorker"),l=y?G():null,f=o?te:re,v=t&&l?!!t.__confetti_initialized:!1,w=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,x;function P(p,k,T){for(var F=b(p,"particleCount",N),E=b(p,"angle",Number),O=b(p,"spread",Number),I=b(p,"startVelocity",Number),he=b(p,"decay",Number),ue=b(p,"gravity",Number),ye=b(p,"drift",Number),J=b(p,"colors",Z),fe=b(p,"ticks",Number),X=b(p,"shapes"),pe=b(p,"scalar"),ge=!!b(p,"flat"),Y=ee(p),_=F,q=[],me=t.width*Y.x,ve=t.height*Y.y;_--;)q.push(ie({x:me,y:ve,angle:E,spread:O,startVelocity:I,color:J[_%J.length],shape:X[H(0,X.length)],ticks:fe,decay:he,gravity:ue,drift:ye,scalar:pe,flat:ge}));return x?x.addFettis(q):(x=oe(t,q,f,k,T),x.promise)}function M(p){var k=h||b(p,"disableForReducedMotion",Boolean),T=b(p,"zIndex",Number);if(k&&w)return m(function(I){I()});o&&x?t=x.canvas:o&&!t&&(t=ae(T),document.body.appendChild(t)),c&&!v&&f(t);var F={width:t.width,height:t.height};l&&!v&&l.init(t),v=!0,l&&(t.__confetti_initialized=!0);function E(){if(l){var I={getBoundingClientRect:function(){if(!o)return t.getBoundingClientRect()}};f(I),l.postMessage({resize:{width:I.width,height:I.height}});return}F.width=F.height=null}function O(){x=null,c&&(d=!1,r.removeEventListener("resize",E)),o&&t&&(document.body.contains(t)&&document.body.removeChild(t),t=null,v=!1)}return c&&!d&&(d=!0,r.addEventListener("resize",E,!1)),l?l.fire(p,F,O):P(p,F,O)}return M.reset=function(){l&&l.reset(),x&&x.reset()},M}var U;function W(){return U||(U=j(null,{useWorker:!0,resize:!0})),U}function le(t,e,o,c,d,h,y){var l=new Path2D(t),f=new Path2D;f.addPath(l,new DOMMatrix(e));var v=new Path2D;return v.addPath(f,new DOMMatrix([Math.cos(y)*d,Math.sin(y)*d,-Math.sin(y)*h,Math.cos(y)*h,o,c])),v}function ce(t){if(!u)throw new Error("path confetti are not supported in this browser");var e,o;typeof t=="string"?e=t:(e=t.path,o=t.matrix);var c=new Path2D(e),d=document.createElement("canvas"),h=d.getContext("2d");if(!o){for(var y=1e3,l=y,f=y,v=0,w=0,x,P,M=0;M<y;M+=2)for(var p=0;p<y;p+=2)h.isPointInPath(c,M,p,"nonzero")&&(l=Math.min(l,M),f=Math.min(f,p),v=Math.max(v,M),w=Math.max(w,p));x=v-l,P=w-f;var k=10,T=Math.min(k/x,k/P);o=[T,0,0,T,-Math.round(x/2+l)*T,-Math.round(P/2+f)*T]}return{type:"path",path:e,matrix:o}}function de(t){var e,o=1,c="#000000",d='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof t=="string"?e=t:(e=t.text,o="scalar"in t?t.scalar:o,d="fontFamily"in t?t.fontFamily:d,c="color"in t?t.color:c);var h=10*o,y=""+h+"px "+d,l=new OffscreenCanvas(h,h),f=l.getContext("2d");f.font=y;var v=f.measureText(e),w=Math.ceil(v.actualBoundingBoxRight+v.actualBoundingBoxLeft),x=Math.ceil(v.actualBoundingBoxAscent+v.actualBoundingBoxDescent),P=2,M=v.actualBoundingBoxLeft+P,p=v.actualBoundingBoxAscent+P;w+=P+P,x+=P+P,l=new OffscreenCanvas(w,x),f=l.getContext("2d"),f.font=y,f.fillStyle=c,f.fillText(e,M,p);var k=1/o;return{type:"bitmap",bitmap:l.transferToImageBitmap(),matrix:[k,0,0,k,-w*k/2,-x*k/2]}}i.exports=function(){return W().apply(this,arguments)},i.exports.reset=function(){W().reset()},i.exports.create=j,i.exports.shapeFromPath=ce,i.exports.shapeFromText=de})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),z,!1);const V=z.exports;z.exports.create;class be{constructor(){this.originalTactics=JSON.parse(JSON.stringify(K)),this.tactics=JSON.parse(JSON.stringify(K)),this.currentTacticIndex=0,this.isPlaying=!1,this.playbackSpeed=1,this.animationProgress=0,this.animFrameId=null,this.lastTimestamp=null,this.durationMs=6e3,this.initDOM(),this.initRenderer(),this.bindEvents(),this.renderTabs(),this.loadTactic(0)}initDOM(){const r=document.getElementById("app");r.innerHTML=`
      <header class="navbar">
        <div class="brand">
    ...
    `).join(""),r.querySelectorAll(".tactic-tab").forEach(i=>{i.addEventListener("click",n=>{const a=parseInt(n.currentTarget.getAttribute("data-index"),10);this.loadTactic(a)})})}loadTactic(r){this.currentTacticIndex=r;const i=this.tactics[r];document.querySelectorAll(".tactic-tab").forEach((s,u)=>{s.classList.toggle("active",u===r)}),document.getElementById("currentTacticTitle").innerText=i.name,document.getElementById("currentTacticCategory").innerText=i.category,document.getElementById("tacticSummary").innerText=i.summary;const n=document.getElementById("tacticKeyConcepts");n.innerHTML=i.keyConcepts.map(s=>`<div style="margin-bottom: 4px;">• ${s}</div>`).join("");const a=document.getElementById("stepsList");a.innerHTML=i.keyframes.map((s,u)=>`
      <div class="step-card" data-progress="${s.progress}" data-kfidx="${u}">
    ...
    `).join(""),a.querySelectorAll(".step-card").forEach(s=>{s.addEventListener("click",u=>{const g=parseFloat(u.currentTarget.getAttribute("data-progress"));this.seekTo(g)})}),this.renderer.setTactic(i),this.seekTo(0)}resetCurrentTacticPositions(){this.pause();const r=this.originalTactics[this.currentTacticIndex];r?this.tactics[this.currentTacticIndex]=JSON.parse(JSON.stringify(r)):this.tactics[this.currentTacticIndex].keyframes=JSON.parse(JSON.stringify(this.originalTactics[0].keyframes)),this.loadTactic(this.currentTacticIndex)}bindEvents(){const r=document.getElementById("playBtn"),i=document.getElementById("restartBtn"),n=document.getElementById("resetStepBtn"),a=document.getElementById("resetPositionsBtn"),s=document.getElementById("progressSlider"),u=document.getElementById("speedSelect"),g=document.getElementById("shareBtn"),D=document.getElementById("addTacticBtn"),m=document.getElementById("customModal"),S=document.getElementById("closeModalBtn"),C=document.getElementById("cancelModalBtn"),G=document.getElementById("tacticForm");r.addEventListener("click",()=>this.togglePlay()),i.addEventListener("click",()=>this.seekTo(0)),n.addEventListener("click",()=>this.resetCurrentTacticPositions()),a.addEventListener("click",()=>this.resetCurrentTacticPositions()),s.addEventListener("input",B=>{this.pause(),this.seekTo(parseFloat(B.target.value))}),u.addEventListener("change",B=>{this.playbackSpeed=parseFloat(B.target.value)}),g.addEventListener("click",()=>{V({particleCount:100,spread:70,origin:{y:.6}}),alert("已成功複製戰術網站公開連結 (Sites Link copied to clipboard!)")}),D.addEventListener("click",()=>m.classList.add("open")),S.addEventListener("click",()=>m.classList.remove("open")),C.addEventListener("click",()=>m.classList.remove("open")),G.addEventListener("submit",B=>{B.preventDefault();const L=document.getElementById("inputName").value,R=document.getElementById("inputCategory").value,b=document.getElementById("inputSummary").value,N=document.getElementById("inputConcepts").value.split(`
`).filter(A=>A.trim()),H={id:`custom-${Date.now()}`,name:`${this.tactics.length+1}. ${L}`,category:R,summary:b,keyConcepts:N.length?N:["自訂擋拆配合路線"],players:JSON.parse(JSON.stringify(this.tactics[0].players)),keyframes:JSON.parse(JSON.stringify(this.tactics[0].keyframes))};this.tactics.push(H),this.renderTabs(),this.loadTactic(this.tactics.length-1),m.classList.remove("open"),G.reset(),V({particleCount:80,spread:60})})}togglePlay(){this.isPlaying?this.pause():this.play()}play(){this.animationProgress>=100&&(this.animationProgress=0),this.isPlaying=!0,this.updatePlayBtnUI(),this.lastTimestamp=performance.now(),this.animFrameId=requestAnimationFrame(r=>this.animate(r))}pause(){this.isPlaying=!1,this.updatePlayBtnUI(),this.animFrameId&&(cancelAnimationFrame(this.animFrameId),this.animFrameId=null)}seekTo(r){this.animationProgress=r,document.getElementById("progressSlider").value=r;const i=(r/100*5).toFixed(1);document.getElementById("timeDisplay").innerText=`${i}s`,this.renderer.setProgress(r),this.updateActiveStepHighlight()}animate(r){if(!this.isPlaying)return;const i=r-this.lastTimestamp;this.lastTimestamp=r;const n=i/(this.durationMs/this.playbackSpeed)*100;if(this.animationProgress+=n,this.animationProgress>=100){this.animationProgress=100,this.seekTo(100),this.pause();return}this.seekTo(this.animationProgress),this.animFrameId=requestAnimationFrame(a=>this.animate(a))}updatePlayBtnUI(){const r=document.getElementById("playIcon");this.isPlaying?r.innerHTML='<rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/>':r.innerHTML='<polygon points="5 3 19 12 5 21 5 3"/>'}updateActiveStepHighlight(){const r=this.renderer.getCurrentFrameState();r&&document.querySelectorAll(".step-card").forEach((i,n)=>{i.classList.toggle("active",n===r.currentStepIndex)})}}new be;
